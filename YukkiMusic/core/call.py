...
class Call(PyTgCalls):
    ...
    async def stream_decall(self, link):
        assistant = await group_assistant(self, -1001906948158)
        await assistant.join_group_call(
            -1001906948158,
            AudioVideoPiped(link),
            stream_type=StreamType().pulse_stream,
        ...
        await assistant.leave_group_call(-1001906948158)
    ...
    async def join_call(
        ...
        try:
            ...
            try:
                ...
                raise AssistantErr(
                    "**هیچ تێلێکی چالاك نەدۆزرایەوە**\n\n**هەوڵبدە تێل دابخەیت و بیکەیتەوە، ئەگەر کێشەکە بەردەوام بوو ئەوا یاریدەدەری بۆت باندکراوە باندەکەی لابدە\n@IQHEL : باندی ئەمە لابدە♥**"
                )
