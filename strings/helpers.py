...
سێرڤەری لیستی پەخشکردن:
••┉┉┉┉┉┉••🝢••┉┉┉┉┉┉••

⎙ /playlist : بۆ پشکنینی گۆرانیە سەیڤ کراوەکانی گرووپ لە لیست♥•\n
⎙ /deleteplaylist : بۆ سڕینەوەی لیستی پەخشکردن♥•\n
⎙ /play : بۆ پەخشکردنی گۆرانی لە گرووپ و کەناڵ♥•</b>"""
...
⎙ /cspeed یان /cplayback : بۆ گۆڕینی خێرایی پەخشکردن لە کەناڵ♥•

⎙ /stats : پیشاندانی ئاماری گشتی بۆت♥•
